...
let savedQuestion;
let questionService;
const questionData = { question: 'MockQuestion', answer: 'MockAnswer', points: 20 };
...
describe('Question', () =>{
    ...
    describe('Find questions', () =>{
        ...
        it('Should return a conflict if a question does not exist',async()=>{
            const fakeQuestion = new questionModel({question: 'fakeQuestion',answer: 'fakeAnswer',points: -1});
   ...
   describe('Delete question', () =>{
    it('should delete a question', async() =>{
        ...
        it('should delete a question and recognize if it is not there', async() => {
            ...
            const resultDelete = await questionModel
                .deleteOne({_id:newId})
                .exec()
